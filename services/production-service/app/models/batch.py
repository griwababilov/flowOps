...
class Batch(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "produced_quantity >= 0", name="check_produced_quantity_non_negative"
        ),
        CheckConstraint(
            "accepted_quantity >= 0", name="check_accepted_quantity_non_negative"
        ),
        CheckConstraint(
            "defect_quantity >= 0", name="check_defect_quantity_non_negative"
        ),
        CheckConstraint(
